        ...
        >
          <div className="w-full max-w-md bg-white/95 backdrop-blur-xl p-6 sm:p-8 lg:p-10 rounded-[2.5rem] shadow-2xl shadow-black/8 border border-black/5 relative">
            ...
            <div className="mb-6 sm:mb-7">
              <h2 className="text-2xl sm:text-3xl font-bold tracking-tight text-bcn-black mb-2">Create an account</h2>
              <p className="text-muted-foreground text-sm">Get started with your BCN workspace.</p>
            </div>
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                ...
                <Button 
                  type="submit" 
                  className="w-full rounded-2xl bg-bcn-red hover:bg-bcn-red/90 text-white font-bold py-6 text-base shadow-lg shadow-bcn-red/20 hover:shadow-xl hover:shadow-bcn-red/30 hover:-translate-y-0.5 active:translate-y-0 transition-all cursor-pointer mt-2"
                  disabled={isLoading || isGoogleLoading}
                >
                  {isLoading ? (
