...
export default function RegisterPage() {
  ...
  return (
    <div className="w-full max-w-xl bg-white p-8 rounded-[2rem] shadow-xl">
      <div className="text-center mb-8">
        <h1 className="text-3xl font-bold tracking-tight mb-2">Create an account</h1>
        <p className="text-muted-foreground text-sm">Get started with Business Compliance Navigator</p>
      </div>
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
          ...
          <Button 
            type="submit" 
            className="w-full rounded-xl bg-bcn-red hover:bg-bcn-red/90 text-white font-semibold py-6 mt-4"
            disabled={isLoading}
          >
      ...
      <div className="mt-8 text-center text-sm">
        ...
        <Link href="/login" className="font-semibold text-bcn-red hover:underline">
          Login
        </Link>
      </div>
    </div>
